...
namespace AngularCircus.web.Migrations
{
    ...
    [Migration("20170222165418_RemovedPossessionMigration")]
    partial class RemovedPossessionMigration
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("AngularCircus.web.Models.Act", b =>
                {
                    ...
                    b.HasOne("AngularCircus.web.Models.Performer", "Performer")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AngularCircus.web.Data.ApplicationUser")
                        .WithMany("Claims")
